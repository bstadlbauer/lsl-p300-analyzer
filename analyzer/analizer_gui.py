...
from ttk import Separator, Combobox, Button, Label, Entry, Checkbutton
from pylsl import resolve_byprop
import multiprocessing as mp
from connect import ConnectorProc

# for testing:
from testserver import BCNIDataServer
...
class MainWindow(object):
    ...
    def __init__(self, master):
        ...
        self.update_interval_combobox["values"] = range(10)
    ...
    def update_channel_select(self):
        ...
        self.channel_select_combobox["values"] = range(num_channels)
